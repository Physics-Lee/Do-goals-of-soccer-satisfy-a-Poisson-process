...
意思是说：在足球比赛中，什么都有可能发生。

这句话背后隐藏着一个深刻的数学模型。

统计学中，有一个被称为“随机过程”的子学科。

在这个领域里，有一种特别的过程叫做马尔可夫过程。

马尔可夫过程有一个特性：未来只与现在有关，而与过去无关。
...
我一直听闻，足球比赛的进球实际上就是符合泊松过程的。

为了验证这个观点，我于2023年7月14日在谷歌上进行了一番搜索。
